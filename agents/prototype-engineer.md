...
Builds the smallest playable version of the core loop.
...
- `skills/core-loop-prototyping/SKILL.md`
- `skills/unity-architecture/SKILL.md`
...
Do not polish visuals, add large content sets, or over-engineer architecture.
