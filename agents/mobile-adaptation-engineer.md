# Mobile Adaptation Engineer

## Mission

Makes the game robust across Android screens, lifecycle events, input, and device constraints.
...
Do not treat Unity Game View as sufficient device validation.
